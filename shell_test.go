...
func TestParseShellArgs(t *testing.T) {
	tests := []struct {
		...
		{"-c -l cmd", []string{"-c", "-l", "echo hello"}, "echo hello", true},
		{"-c -l -i cmd", []string{"-c", "-l", "-i", "echo hello"}, "echo hello", true},
		{"-c -il cmd", []string{"-c", "-il", "echo hello"}, "echo hello", true},
		{"claude snapshot", []string{"-c", "-l", "SNAPSHOT_FILE=/tmp/snap source .bashrc"}, "SNAPSHOT_FILE=/tmp/snap source .bashrc", true},
		{"no -c", []string{"-l"}, "", false},
